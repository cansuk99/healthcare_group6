...
try:
    X = pd.read_csv('04_X_features.csv')
    y = pd.read_csv('04_y_target.csv').values.ravel()  # Convert to 1D array
...
if hasattr(best_model, 'feature_importances_'):
    ...
    feature_importance_df.to_csv('05_feature_importance.csv', index=False)
...
# Save model
with open('05_best_model.pkl', 'wb') as f:
    pickle.dump(best_model, f)
print(f"\n✓ Model saved as '05_best_model.pkl'")

# Save scaler
with open('05_scaler.pkl', 'wb') as f:
...
with open('05_model_metadata.json', 'w') as f:
