...
try:
    ...
    y = pd.read_csv(
        "../data/selected-features/04_y_target.csv"
...
print(
    classification_report(
        y_test, best_results["y_pred"], target_names=["Not Readmitted", "Readmitted"]
    )
)
...
for model in models.keys():
    ...
    best_metrics = [
        ...
        selected_results["f1_score"],
        selected_results["roc_auc"],
    ]
    metric_names = ["Accuracy", "Precision", "Recall", "F1-Score", "ROC-AUC"]
    ...
    plt.tight_layout()
    plt.savefig(
        f"../figures/05_model_evaluation_{model}.png", dpi=300, bbox_inches="tight"
    )
    print("  ✓ Saved: 05_model_evaluation.png")
